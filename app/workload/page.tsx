  ...
  return (
    <div className="mt-6">
      ...
      <p className="text-xs text-ink4 mb-4">
        Weekly-report status, ClickUp load, and WebWork hours per person - same
        rollup used on Performance &rarr; People Audit.
      </p>

      {loading ? (
        <div className="py-6">
          <Spinner label="Loading workload…" className="text-ink4 text-sm" />
        </div>
