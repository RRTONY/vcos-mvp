...
export default function RichTextEditor({
  ...
  return (
    <div
      className={`border border-sand4 rounded-lg overflow-hidden ${disabled ? "opacity-60" : "focus-within:ring-2 focus-within:ring-accent/20 focus-within:border-accent"} transition-colors`}
    >
      {!disabled && (
      ...
      <div className="relative">
        {isEmpty && placeholder && (
          <div className="absolute top-2.5 left-3 text-sm text-ink4 pointer-events-none">
            {placeholder}
          </div>
        )}
        <div
